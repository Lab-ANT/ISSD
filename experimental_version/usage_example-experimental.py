from issd_experimental import ISSD
...
# plot the selected channels respectively in 3 vertical subplots
fig, axs = plt.subplots(2, 1, figsize=(20, 10))
axs[0].plot(data[:,selected_channels_qf], label='QF')
axs[1].plot(data[:,selected_channels_cf], label='CF')
