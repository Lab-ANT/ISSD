...
result_path = f'downstream_methods/AutoPlait/output/CaseStudy'
temp_path = f'downstream_methods/AutoPlait/data/CaseStudy'
output_path = f'output/results/case_study/autoplait'
os.makedirs(output_path, exist_ok=True)
fname_list = os.listdir(f'data/CaseStudy')
fname_list.sort()
for i, fname in enumerate(fname_list):
    ...
    np.save(os.path.join(output_path, f'case{i+1}.npy'), np.vstack((prediction, groundtruth)))